...
import { getOptimizelyCmsContentUrl } from '@/lib/optimizely/env'
...
const RightFloatingMenuComponent = ({ pageData }: { pageData?: any }) => {
  ...
  const optimizelyCmsContentUrl = getOptimizelyCmsContentUrl()
  const optimizelyCmsBase = optimizelyCmsContentUrl.replace(/#.*$/, '')
  ...
  const cmsLinks = [
    ...
    ...(optimizelyCmsContentUrl
      ? [
          {
            label: 'CMS',
            url: optimizelyCmsContentUrl,
            external: true
          },
          {
            label: 'Content Types',
